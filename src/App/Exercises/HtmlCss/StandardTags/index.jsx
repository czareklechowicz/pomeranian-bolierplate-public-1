  ...
  return (
    <>
      ...
      <div class="faked-tags">
        ...
        <div className="small-date">05.2023</div>

        <div className="h3">
          H<span className="first-title-span">2</span>O is good for you
        </div>
        ...
        <div className="second-content">
          Make the next birthday you celebrate a special one with a hand-picked
          happy birthday <span className="quote-span">quote</span> or wish that
          ...
          our list of <span>happy birthday</span>{' '}
          <span className="quote-span">quotes</span> to help put a smile on
          someone’s face. From inspirational to funny to cute sayings, browse
          our list of <span className="quote-span">quotes</span> to find one
          that resonates with you. <span>Nothing</span> can stop you!
        </div>

        <div className="h3">
          Why not to use <span className="list-span">lists</span> ?
        </div>
